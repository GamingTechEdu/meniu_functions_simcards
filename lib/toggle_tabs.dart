...
import 'package:menu_functions_simcards/called_filter_tabs.dart';
...
class ToogleTabsState extends State<ToogleTabs> {
            ...
            onPressed: (int index) {
              ...
              setState(() {
                if (widget.onTabSelect != null) {
                  CalledFilterTabs calledFilterTabs =
                      CalledFilterTabs(widget.activeStatus);
  ...
  Widget markerSelected(index) {
    return Container(
      ...
      decoration: BoxDecoration(
          color:
              (activeIndex == index) ? Colors.blueAccent : Colors.transparent,
